...
export const SLIP_FIELD_GROUPS: { title: string; keys: SlipFieldKey[] }[] = [
  { title: 'Vehicle & Documents', keys: ['truckNo', 'grNo', 'invoiceNo', 'doNo'] },
  { title: 'Parties', keys: ['consignor', 'consignee'] },
  { title: 'Route', keys: ['fromLocation', 'toLocation'] },
  { title: 'Driver', keys: ['driverName', 'driverAddress'] },
  { title: 'Owner', keys: ['ownerName', 'ownerAddress'] },
  { title: 'Cargo', keys: ['bags', 'weight', 'rate'] },
  { title: 'Payment', keys: ['freight', 'advance', 'cash', 'diesel', 'bank', 'commission', 'missing'] },
];
